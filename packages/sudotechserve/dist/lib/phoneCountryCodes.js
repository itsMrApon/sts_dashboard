...
export const SORTED_ISO2 = Object.keys(DIAL_BY_ISO2).sort((a, b) => countryLabel(a).localeCompare(countryLabel(b), 'en'));
export function dialForIso2(iso2) {
    return DIAL_BY_ISO2[iso2.toUpperCase()] ?? '+1';
}

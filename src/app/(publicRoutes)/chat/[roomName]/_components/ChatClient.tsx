...
export const ChatClient = ({
  ...
  const submitMobileCallback = useCallback(async () => {
    ...
    try {
      const res = await fetch(`/api/chat/${encodeURIComponent(roomName)}/mobile-callback`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  }, [consent, countryIso, mobileMessage, mobileName, mobilePhone, mobileSubmitting, roomName])

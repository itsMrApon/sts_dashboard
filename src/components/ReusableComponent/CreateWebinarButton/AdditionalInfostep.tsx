...
const AdditionalInfostep = (props: Props) => {
  const { formData, updateAdditionalInfoField, getStepValidationErrors } = useStsStore()
        ...
        {couponEnabled && (
          <div className="space-y-2">
            ...
            <div className="flex items-start gap-2 text-sm text-gray-400 mt-2">
              ...
              <p>
                This coupon code can be used to promote a sale. Users can use it for the book or order now button.
              </p>
            </div>
          </div>
        )}

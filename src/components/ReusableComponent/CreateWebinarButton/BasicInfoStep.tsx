...
const BasicInfoStep = (props: Props) => {
  ...
  const handleDateChange = (newDate: Date | undefined) => {
    if (newDate) {
      ...
      if (newDate < today) {
        toast.error('Video date cannot be in the past')
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <Input
          ...
          placeholder="Introduce your product or service"
          className={cn (
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          value={description || ""}
          onChange={handleChange}
          placeholder="Tell customers what your product/service is about"
          className={cn (
            '!bg-background/50 border border-input',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <Label className={errors.date ? 'text-red-400' : ''}>
            Video Date <span className=" text-red-400">*</ span>
          </Label>
          <Popover>
            <PopoverTrigger asChild>
              <Button 
                variant="outline"
                className={cn (
                  'w-full justify-start text-left font-normal !bg-background/50 borderborder-input',
                  !date && 'text-gray-500',
        ...
        <div className="space-y-2">
          <Label className={errors.time ? 'text-red-400' : ''}>
            Video Time <span className=" text-red-400">*</ span>
          </Label>

...
interface MultiSelectProps
	...
	/**
	 * If true, hides the clear-all (X) button on the trigger.
	 * Optional, defaults to false.
	 */
	hideClearButton?: boolean;

	/**
	 * If true, hides the Clear / Close footer actions in the popover.
	 * Optional, defaults to false.
	 */
	hideFooterActions?: boolean;

	/**
	 * Optional footer action (e.g. "+ Add connector") shown at the bottom of the list.
	 */
	addOption?: {
		label: string
		onSelect: () => void
